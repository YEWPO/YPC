    ...
    test("ImmGen") {
      ...
      test("S-type") {
        testCircuit(new ImmGen()) { dut =>
          ...
          dut.io.imm_type.poke(ImmType.IMM_TYPE_S)
          dut.clock.step()
      ...
      test("B-type") {
        testCircuit(new ImmGen()) { dut =>
          ...
          dut.io.imm_type.poke(ImmType.IMM_TYPE_B)
          dut.clock.step()
      ...
      test("U-type") {
        testCircuit(new ImmGen()) { dut =>
          ...
          dut.io.imm_type.poke(ImmType.IMM_TYPE_U)
          dut.clock.step()
      ...
      test("J-type") {
        testCircuit(new ImmGen()) { dut =>
          ...
          dut.io.imm_type.poke(ImmType.IMM_TYPE_J)
          dut.clock.step()
