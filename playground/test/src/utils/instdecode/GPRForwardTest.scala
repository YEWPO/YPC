    ...
    test("Forward") {
      ...
      test("alu_E") {
        testCircuit(new GPRForward) { dut =>
          ...
          dut.io.snpc_M.poke(6.U)
          dut.io.wb_data.poke(7.U)
          dut.io.f_ctl.poke(HazardMacros.F_CTL_ALU_E)
          dut.clock.step()
      ...
      test("snpc_E") {
        testCircuit(new GPRForward) { dut =>
          ...
          dut.io.snpc_M.poke(6.U)
          dut.io.wb_data.poke(7.U)
          dut.io.f_ctl.poke(HazardMacros.F_CTL_SNPC_E)
          dut.clock.step()
      ...
      test("alu_M") {
        testCircuit(new GPRForward) { dut =>
          ...
          dut.io.snpc_M.poke(6.U)
          dut.io.wb_data.poke(7.U)
          dut.io.f_ctl.poke(HazardMacros.F_CTL_ALU_M)
          dut.clock.step()
      ...
      test("mem_M") {
        testCircuit(new GPRForward) { dut =>
          ...
          dut.io.snpc_M.poke(6.U)
          dut.io.wb_data.poke(7.U)
          dut.io.f_ctl.poke(HazardMacros.F_CTL_MEM_M)
          dut.clock.step()
      ...
      test("snpc_M") {
        testCircuit(new GPRForward) { dut =>
          ...
          dut.io.snpc_M.poke(6.U)
          dut.io.wb_data.poke(7.U)
          dut.io.f_ctl.poke(HazardMacros.F_CTL_SNPC_M)
          dut.clock.step()
      ...
      test("wb_data") {
        testCircuit(new GPRForward) { dut =>
          ...
          dut.io.snpc_M.poke(6.U)
          dut.io.wb_data.poke(7.U)
          dut.io.f_ctl.poke(HazardMacros.F_CTL_WB_DATA)
          dut.clock.step()
