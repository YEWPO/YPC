    ...
    test("ControlUnitTest") {
      test("U-type_lui") {
        testCircuit(new ControlUnit) { dut =>
          ...
          dut.io.mem_w_en.expect(ControlMacro.MEM_W_DISABLE)
          dut.io.mem_mask.expect(ControlMacro.MEM_MASK_DEFAULT)
      ...
      test("S-type_sh") {
        testCircuit(new ControlUnit) { dut =>
          ...
          dut.io.mem_w_en.expect(ControlMacro.MEM_W_ENABLE)
          dut.io.mem_mask.expect(ControlMacro.MEM_MASK_2BYTE)
