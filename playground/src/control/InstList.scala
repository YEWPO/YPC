...
object InstList {
  ...
  val mul    = BitPat("0000001_?????_?????_000_?????_01100_11")
  val mulh   = BitPat("0000001_?????_?????_001_?????_01100_11")
  val mulhsu = BitPat("0000001_?????_?????_010_?????_01100_11")
  val mulhu  = BitPat("0000001_?????_?????_011_?????_01100_11")
  val mulw   = BitPat("0000001_?????_?????_000_?????_01110_11")

  val div  = BitPat("0000001_?????_?????_100_?????_01100_11")
  val divu = BitPat("0000001_?????_?????_101_?????_01100_11")
  val rem  = BitPat("0000001_?????_?????_110_?????_01100_11")
  val remu = BitPat("0000001_?????_?????_111_?????_01100_11")

  val divw  = BitPat("0000001_?????_?????_100_?????_01110_11")
  val divuw = BitPat("0000001_?????_?????_101_?????_01110_11")
  val remw  = BitPat("0000001_?????_?????_110_?????_01110_11")
  val remuw = BitPat("0000001_?????_?????_111_?????_01110_11")
