...
| 测试编号 | 测试内容                  | 输入条件                                                     | 期望结果                                                     | 实际结果 |
| -------- | ------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | -------- |
| 1        | sraiw一条常规指令         | r_data1：0x8000_0000<br />r_data2：2<br />imm：b110000<br />dnpc_ctl：DNPC_CTL_DEFAULT<br />pc：0x8000_0010<br />jump_op：JUMP_OP_DEFAULT<br />alu_ctl = ALU_CTL_SRAW | jump_ctl：false<br />dnpc：0x8000_0040<br />alu_out = 0xffff_8000 |          |
| 2        | bne跳转指令，但是跳转失败 | r_data1：0x1<br />r_data2：0x1<br />imm：0x10<br />dnpc_ctl：DNPC_CTL_PC<br />pc：0x8000_0200<br />jump_op：JUMP_OP_BRANCE<br />alu_ctl：ALU_CTL_NEQ | jump_ctl = false<br />dnpc：0x8000_0210<br />alu_out = 0     |          |
| 3        | bge跳转指令，跳转成功     | r_data1：0x1<br />r_data2：0x1<br />imm：0x10<br />dnpc_ctl：DNPC_CTL_PC<br />pc：0x8000_0200<br />jump_op：JUMP_OP_BRANCH<br />alu_ctl：ALU_CTL_SGE | jump_ctl = true<br />dnpc：0x8000_0210<br />alu_out = 1      |          |
| 4        | jalr跳转指令              | r_data1：0x1<br />r_data2：0x8000_0000<br />imm：JUMP_OP_JAL<br />dnpc_ctl：DNPC_CTL_SRC2<br />pc：0x8000_0200<br />jump_op：b01 | jump_ctl = true<br />dnpc：0x8000_0010                       |          |
